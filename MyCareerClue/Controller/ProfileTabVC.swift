...
class ProfileTabVC: ButtonBarPagerTabStripViewController {
    ...
    var getOwner = String()
    var bio = String()
let purpleInspireColor = UIColor.init(red: 109/256, green: 169/256, blue: 224/256, alpha: 1.0)
    override func viewDidLoad() {
        
        self.settings.style.buttonBarBackgroundColor = UIColor.init(red: 109/256, green: 169/256, blue: 224/256, alpha: 1.0)
        self.settings.style.buttonBarItemBackgroundColor = UIColor.init(red: 109/256, green: 169/256, blue: 224/256, alpha: 1.0)
        buttonBarView.backgroundColor = UIColor(red: 109/255, green: 169/255, blue: 224/255, alpha: 1)
        ...
        actionButton.addItem(title: "New Collection", image: UIImage(named: "edit.png")?.withRenderingMode(.alwaysTemplate)) { item in
        ...
        actionButton.addItem(title: "New Chapter", image: UIImage(named: "edit.png")?.withRenderingMode(.alwaysTemplate)) { item in
            // do something
            let StoryBoard   = UIStoryboard(name: "Main", bundle: nil)
        ...
        actionButton.addItem(title: "New Clue", image: UIImage(named: "edit.png")?.withRenderingMode(.alwaysTemplate)) { item in
            // do something
            let storyBoard = UIStoryboard(name: "Main", bundle: nil)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.buttonBarView.moveTo(index: 0, animated: true, swipeDirection: .right, pagerScroll: .yes)
        }
    }
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        return [child_1,child_4,child_3,child_2]
